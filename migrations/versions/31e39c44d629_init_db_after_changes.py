...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["team_leader_id"], ["user.id"], name="fk_team_leader_id", use_alter=True
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        op.f("ix_part_details_production_date"),
        "part_details",
        ["production_date"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_reclamation_due_date"), "reclamation", ["due_date"], unique=False
    )
    op.create_index(
        op.f("ix_reclamation_finished_date"),
        "reclamation",
        ["finished_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_reclamation_informed_date"),
        "reclamation",
        ["informed_date"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["rec_id"], ["reclamation.id"],),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_note_creation_date"), "note", ["creation_date"], unique=False
    )
    op.create_table(
        "ticket",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_ticket_creation_date"), "ticket", ["creation_date"], unique=False
    )
    op.create_index(op.f("ix_ticket_due_date"), "ticket", ["due_date"], unique=False)
    op.create_index(
        op.f("ix_ticket_finished_date"), "ticket", ["finished_date"], unique=False
    )
